...
console.log("Return an array of just the universities");
...
console.log("******************* ADVANCED ARRAY QUESTIONS *******************");
...
const populationTotal = zooAnimals.reduce((accumlator, curValue) => accumlator + curValue.population, 0);
